...
class RedisDB:
    ...
    def __init__(self):
        ...
        if not redis_url or not redis_token:
            logger.warning("Upstash Redis credentials not found, using local Redis")
    ...
    def save_student(self, student_id, student_data):
        ...
        return self.client.set(key, json.dumps(student_data), ex=86400*365)  # 一年过期
    ...
    def create_conversation(self, conv_id, student_id, group_info, llm_type, title):
        ...
        return self.client.set(key, json.dumps(conv_data), ex=86400*30)  # 30天过期
